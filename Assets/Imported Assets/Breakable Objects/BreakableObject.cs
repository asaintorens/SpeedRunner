...
public class BreakableObject:MonoBehaviour{
    public int forceHautBas = 100;
    public int forceGaucheDroite = 200;
	...
	public IEnumerator breakObject() {// breaks object
	    ...
	    if (!broken) {
            ...
            fragmentd.gameObject.layer = 8;
            fragmentd.gameObject.AddComponent<AutoDestroy>();
	        ...
	        foreach(Transform child in frags) {
				...
				child.GetComponent<Rigidbody>().AddForce(Random.Range(300, explosiveForce), Random.Range(-this.forceHautBas, forceHautBas), Random.Range(-this.forceGaucheDroite, this.forceGaucheDroite));
